...
Scenario Outline: Create a Test App
  Given path '/test'
  And request
    """
    {
      ...
      "additional_info": {
        ...
        "cloudWatchConfig": {
          ...
          "cw_credentials": {
            ...
            "credentials_file": {
              "file_name": "<cw_credentials_file_name>",
              "file_content": "<cw_credentials_file_content>"
            },
