...
# ********RoostGPT********
Here's the corrected Gherkin feature file with the parsing errors fixed:
...
Scenario Outline: Create a new application with its configuration
  ...
  Examples:
    ...
    | 'test_app_id' | 'Test App 1' | ['push', 'pr_create'] | true | 'github' | 'conn_123' | 'openai' | 'token_123' | 'gpt-3' | 'Vertex Model' | 'vm_key' | 'vertex_proj_1' | 'vertex_endpoint_1' | 'vertex_type_1' | '192.168.1.1' | 'open_source_model_1' | 'Claude Model' | 'cm_key' | '192.168.1.2' | 'star_chat_model_1