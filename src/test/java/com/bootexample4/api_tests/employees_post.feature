...
Scenario Outline: Add Employee
  ...
  Examples:
    | id                                  | jobTitle        | name       | email                 | responseCode | description                |
    | 'd290f1ee-6c54-4b01-90e6-d701748f0851' | 'System Analyst' | 'John Smith' | 'john.smith@acme-corp.com' | 201          | 'employee created'         |
    | 'd290f1ee-6c54-4b01-90e6-d701748f0851' | 'System Analyst' | 'John Smith' | 'john.smith@acme-corp.com' | 400          | 'invalid input, object invalid' |
