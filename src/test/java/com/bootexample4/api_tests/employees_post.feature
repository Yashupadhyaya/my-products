...
Feature: Employee Management
    ...
    Scenario Outline: Add an employee to the system
        ...
        And match response contains { description: '<responseDescription>' }

        Examples:
            | id                                     | jobTitle         | name         | email                      | statusCode | responseDescription                   |
            | 'd290f1ee-6c54-4b01-90e6-d701748f0851' | 'System Analyst' | 'John Smith' | 'john.smith@acme-corp.com' | 201        | 'employee created'                    |
            | 'd290f1ee-6c54-4b01-90e6-d701748f0852' | 'System Analyst' | ''           | 'john.doe@acme-corp.com'   | 400        | 'invalid input, object invalid'       |
            | 'd290f1ee-6c54-4b01-90e6-d701748f0851' | 'System Analyst' | 'John Doe'   | 'john.doe@acme-corp.com'   | 409        | 'an existing employee already exists' |
