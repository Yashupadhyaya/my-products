...
public class CreateMyAccountTest {
    ...
    public void createMyAccount() {
        ...
        // GET request to verify the account created
        Response response = 
            given()
            .header("Content-Type", "application/json")
            .when()
        ...
        String accountName = response.jsonPath().getString("accountName");
        assert accountName.equals("Expected Account Name");  // Replace "Expected Account Name" with the expected account name
    }
}
