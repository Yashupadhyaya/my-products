...
public class personsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/personsGetTest.csv");
    }
    ...
    public void personsGet_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.pathParam("birth-date", testData.get("birth-date") != null ? testData.get("birth-date") : "")
