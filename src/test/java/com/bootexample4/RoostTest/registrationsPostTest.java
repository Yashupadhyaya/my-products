...
public class registrationsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/registrationsPostTest.csv");
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.body("{\n"+
					...
					"  \"startDate\": \"" + (testData.get("startDate") != null ? testData.get("startDate") : "") + "\",\n" +
					"  \"endDate\": \"" + (testData.get("endDate") != null ? testData.get("endDate") : "") + "\",\n" +
					"  \"credentialUrl\": \"" + (testData.get("credentialUrl") != null ? testData.get("credentialUrl") : "") + "\n" +
 				"}")
