// ********RoostGPT********
/*
Test generated by RoostGPT for test test-raml-config using AI Type  and AI Model 

Test generated for /helloworld_get for http method type GET in rest-assured framework

RoostTestHash=8a4b2d1632
...
public class helloworldGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/helloworldGetTest.csv", envVarsList);
    }

  
    @Test  
    public void helloworldGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: helloworldGet_Test \n", testNumber++);
              System.out.println("Request: GET /helloworld");
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode.equals("200")){					System.out.println("Status code: 200");
