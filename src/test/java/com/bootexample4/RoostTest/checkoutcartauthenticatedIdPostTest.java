...
Test generated for /checkout-cart-authenticated/{id}_post for http method type POST in rest-assured framework

RoostTestHash=530539e70a
...
public class checkoutcartauthenticatedIdPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/checkout-cart-authenticated_idPostTest.csv");
    }

  
    @Test  
    public void checkoutcartauthenticatedIdPost_Test() {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = testData.get("BASE_URL");  
                ...
                .when()
                .post("/checkout-cart-authenticated/{id}")  
                .then() 
                .extract().response();    
