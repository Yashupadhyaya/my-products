...
// Test generated for /order-report/orders/{id}/sub-orders_get for http method type GET in rest-assured framework


// RoostTestHash=3d95bd4a97
...
public class sub-ordersGetTest {
  
    @Test  
    public void sub-orders_get_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "sub-ordersGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
                ...
                .when()
                .get("/order-report/orders/{id}/sub-orders")  
                .then() 
                .extract().response();    
