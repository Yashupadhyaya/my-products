...
Test generated for /test/event/{trigger_id}/retrigger_post for http method type POST in rest-assured framework

RoostTestHash=7c17afc512
...
public class testEventTriggerIdRetriggerPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/test_event_trigger_id_retriggerPostTest.csv", envVarsList);
    }

  
    @Test  
    public void testEventTriggerIdRetriggerPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/test/event/{trigger_id}/retrigger")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: testEventTriggerIdRetriggerPost_Test \n", testNumber++);
              System.out.println("Request: POST /test/event/{trigger_id}/retrigger");
