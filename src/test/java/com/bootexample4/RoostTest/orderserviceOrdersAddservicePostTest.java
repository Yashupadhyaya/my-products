...
Test generated for /order-service/orders/add-service_post for http method type POST in rest-assured framework
...
public class orderserviceOrdersAddservicePostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/order-service_orders_add-servicePostTest.csv", envVarsList);
    }

  
    @Test  
    public void orderserviceOrdersAddservicePost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/order-service/orders/add-service")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: orderserviceOrdersAddservicePost_Test \n", testNumber++);
              System.out.println("Request: POST /order-service/orders/add-service");
