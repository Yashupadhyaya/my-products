...
public class petFindByStatusGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/pet_findByStatusGetTest.csv", envVarsList);
    }
    ...
    public void petFindByStatusGet_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "/api/v3";  
            ...
            for (int it = 0; it < respoJsonArray.length(); it++) {  
              ...
              if (response.get("id.tags["+ i +"].id") != null) {      
              ...
              if (response.get("id.tags["+ i +"].name") != null) {      
              ...
              if (response.get("name.tags["+ i +"].id") != null) {      
              ...
              if (response.get("name.tags["+ i +"].name") != null) {      
              ...
              if (response.get("category.tags["+ i +"].id") != null) {      
              ...
              if (response.get("category.tags["+ i +"].name") != null) {      
              ...
              if (response.get("photoUrls.tags["+ i +"].id") != null) {      
              ...
              if (response.get("photoUrls.tags["+ i +"].name") != null) {      
              ...
              if (response.get("tags.tags["+ i +"].id") != null) {      
              ...
              if (response.get("tags.tags["+ i +"].name") != null) {      
              ...
              if (response.get("status.tags["+ i +"].id") != null) {      
              ...
              if (response.get("status.tags["+ i +"].name") != null) {      
