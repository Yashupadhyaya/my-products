    ...
    public void accountsAccountIdGet_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "accounts_account-IdGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("account._links.Omikron.XS2A.Service.Models.Link") != null) {    
              if (response.jsonPath().get("account._links.Omikron.XS2A.Service.Models.Link.href") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("account._links.Omikron.XS2A.Service.Models.Link.href"), instanceOf(String.class));  
          }
