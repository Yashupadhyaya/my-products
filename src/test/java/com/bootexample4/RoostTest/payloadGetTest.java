...
// Test generated for /order-report/orders/{id}/payload_get for http method type GET in rest-assured framework


// RoostTestHash=1381d00bca
...
public class payloadGetTest {
  
    @Test  
    public void payload_get_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "payloadGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
                ...
                .when()
                .get("/order-report/orders/{id}/payload")  
                .then() 
                .extract().response();    
