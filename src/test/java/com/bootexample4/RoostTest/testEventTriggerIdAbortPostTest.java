...
Test generated for /test/event/{trigger_id}/abort_post for http method type POST in rest-assured framework

RoostTestHash=9f3d9b2ab5
...
public class testEventTriggerIdAbortPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/test_event_trigger_id_abortPostTest.csv", envVarsList);
    }

  
    @Test  
    public void testEventTriggerIdAbortPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/test/event/{trigger_id}/abort")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: testEventTriggerIdAbortPost_Test \n", testNumber++);
              System.out.println("Request: POST /test/event/{trigger_id}/abort");
