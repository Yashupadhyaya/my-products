...
public class accountsPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/accountsPostTest.csv");
    }
    ...
    public void accountsPost_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.pathParam("commit-hash", testData.get("commit-hash") != null ? testData.get("commit-hash") : "")
