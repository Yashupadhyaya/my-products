...
Test generated for /delete-cart/{id}_put for http method type PUT in rest-assured framework
...
public class deletecartIdPutTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/delete-cart_idPutTest.csv");
    }

  
    @Test  
    public void deletecartIdPut_Test() {
        this.setUp();
