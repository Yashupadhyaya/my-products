    ...
    public void accountsGet_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "accountsGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("accounts["+ i +"]._links.href") != null) {  
                MatcherAssert.assertThat(response.jsonPath().get("accounts["+ i +"]._links.href"), instanceOf(String.class));  
          }
...
if (response.statusCode() == 400) {
              ...
              if (response.jsonPath().get("_links.href") != null) {  
                MatcherAssert.assertThat(response.jsonPath().get("_links.href"), instanceOf(String.class));  
          }
