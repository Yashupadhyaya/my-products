...
public class accountsGetTest {
    ...
    public void accountsGet_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "accountsGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("accounts["+ i +"]._links.Omikron.XS2A.Service.Models.Link") != null) {    
              if (response.jsonPath().get("accounts["+ i +"]._links.Omikron.XS2A.Service.Models.Link.href") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("accounts["+ i +"]._links.Omikron.XS2A.Service.Models.Link.href"), instanceOf(String.class));  
          }
