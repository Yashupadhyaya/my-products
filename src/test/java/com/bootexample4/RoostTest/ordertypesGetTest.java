        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = "https:/serverRoot/com/";  
              ...
              if (response.get("_metadata.hasNext") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.hasNext"), instanceOf(Boolean.class));  
          }
      
              if (response.get("_metadata.count") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.count"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.totalCount") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.totalCount"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.requestId") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.requestId"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.channel") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.channel"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.totalFailedOrderCount") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.totalFailedOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.totalCompletedOrderCount") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.totalCompletedOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.totalPendingOrderCount") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.totalPendingOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("_metadata.totalInProgressOrderCount") != null) {  
                MatcherAssert.assertThat(_metadata.get("_metadata.totalInProgressOrderCount"), instanceOf(String.class));  
          }
