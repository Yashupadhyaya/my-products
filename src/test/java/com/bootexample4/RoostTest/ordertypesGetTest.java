    ...
    public void ordertypesGet_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = "https:/serverRoot/com/";  
              ...
              if (response.get("_metadata") != null) {JsonPath placeholder = response.get("_metadata");
      
              if (response.get("hasNext") != null) {  
                MatcherAssert.assertThat(placeholder.get("hasNext"), instanceOf(Boolean.class));  
          }
      
              if (response.get("count") != null) {  
                MatcherAssert.assertThat(placeholder.get("count"), instanceOf(String.class));  
          }
      
              if (response.get("totalCount") != null) {  
                MatcherAssert.assertThat(placeholder.get("totalCount"), instanceOf(String.class));  
          }
      
              if (response.get("requestId") != null) {  
                MatcherAssert.assertThat(placeholder.get("requestId"), instanceOf(String.class));  
          }
      
              if (response.get("channel") != null) {  
                MatcherAssert.assertThat(placeholder.get("channel"), instanceOf(String.class));  
          }
      
              if (response.get("totalFailedOrderCount") != null) {  
                MatcherAssert.assertThat(placeholder.get("totalFailedOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("totalCompletedOrderCount") != null) {  
                MatcherAssert.assertThat(placeholder.get("totalCompletedOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("totalPendingOrderCount") != null) {  
                MatcherAssert.assertThat(placeholder.get("totalPendingOrderCount"), instanceOf(String.class));  
          }
      
              if (response.get("totalInProgressOrderCount") != null) {  
                MatcherAssert.assertThat(placeholder.get("totalInProgressOrderCount"), instanceOf(String.class));  
          }
