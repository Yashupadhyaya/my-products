...
public class orderOrderIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/order_orderIdDeleteTest.csv");
    }

  
    @Test  
    public void orderOrderIdDelete_Test() {
        this.setUp();
