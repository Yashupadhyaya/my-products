    ...
    public void runsPost_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = "https://api.openai.com/v1";  
				...
				.body("{\n"+
					"  \"assistant_id\": \"" + (testData.get("assistant_id") != null ? testData.get("assistant_id") : "") + "\",\n" +
					"  \"model\": \"" + (testData.get("model") != null ? testData.get("model") : "") + "\",\n" +
					"  \"instructions\": \"" + (testData.get("instructions") != null ? testData.get("instructions") : "") + "\",\n" +
					"  \"additional_instructions\": \"" + (testData.get("additional_instructions") != null ? testData.get("additional_instructions") : "") + "\",\n" +
