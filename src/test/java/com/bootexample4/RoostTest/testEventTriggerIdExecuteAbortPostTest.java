...
Test generated for /test/event/{trigger_id}/execute/abort_post for http method type POST in rest-assured framework

RoostTestHash=d55dc441b8
...
public class testEventTriggerIdExecuteAbortPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {"trigger_id"};
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/test_event_trigger_id_execute_abortPostTest.csv", envVarsList);
    }

  
    @Test  
    public void testEventTriggerIdExecuteAbortPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.pathParam("trigger_id", testData.get("trigger_id") != null ? testData.get("trigger_id") : "")
				.header("Authorization", "Bearer " + testData.get("bearer"))
                .when()
                .post("/test/event/{trigger_id}/execute/abort")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: testEventTriggerIdExecuteAbortPost_Test \n", testNumber++);
              System.out.println("Request: POST /test/event/{trigger_id}/execute/abort");
