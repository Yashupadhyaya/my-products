...
Test generated for /test/event/{trigger_id}/execute_post for http method type POST in rest-assured framework

RoostTestHash=381448fa2c
...
public class testEventTriggerIdExecutePostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/test_event_trigger_id_executePostTest.csv", envVarsList);
    }

  
    @Test  
    public void testEventTriggerIdExecutePost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/test/event/{trigger_id}/execute")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: testEventTriggerIdExecutePost_Test \n", testNumber++);
              System.out.println("Request: POST /test/event/{trigger_id}/execute");
