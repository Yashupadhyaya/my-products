...
Test generated for /listener/workOrderStateChangeEvent_post for http method type POST in rest-assured framework

RoostTestHash=95124eb67a
...
public class listenerWorkOrderStateChangeEventPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/listener_workOrderStateChangeEventPostTest.csv", envVarsList);
    }

  
    @Test  
    public void listenerWorkOrderStateChangeEventPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/listener/workOrderStateChangeEvent")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: listenerWorkOrderStateChangeEventPost_Test \n", testNumber++);
              System.out.println("Request: POST /listener/workOrderStateChangeEvent");
