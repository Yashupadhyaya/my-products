...
Test generated for /test/{test_id}/trigger_post for http method type POST in rest-assured framework

RoostTestHash=909850db38
...
public class testTestIdTriggerPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {"test_id"};
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/test_test_id_triggerPostTest.csv", envVarsList);
    }

  
    @Test  
    public void testTestIdTriggerPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.pathParam("test_id", testData.get("test_id") != null ? testData.get("test_id") : "")
				.header("Authorization", "Bearer " + testData.get("bearer"))
                .when()
                .post("/test/{test_id}/trigger")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: testTestIdTriggerPost_Test \n", testNumber++);
              System.out.println("Request: POST /test/{test_id}/trigger");
