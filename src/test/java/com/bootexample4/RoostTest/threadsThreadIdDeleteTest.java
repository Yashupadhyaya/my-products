...
Test generated for /threads/{thread_id}_delete for http method type DELETE in rest-assured framework

RoostTestHash=cdd9a88059
...
public class threadsThreadIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/threads_thread_idDeleteTest.csv");
    }

  
    @Test  
    public void threadsThreadIdDelete_Test() {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = "https://api.openai.com/v1";  
              ...
              if (response.jsonPath().get("object") != null) {  
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("object"), equalTo("thread.deleted"));  // Changed from anyOf(equalTo("thread.deleted"))
