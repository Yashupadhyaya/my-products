...
public class registrationsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/registrationsGetTest.csv");
    }
    ...
    public void registrationsGet_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.pathParam("recipient-id", testData.get("recipient-id") != null ? testData.get("recipient-id") : "")
				.pathParam("credential-url", testData.get("credential-url") != null ? testData.get("credential-url") : "")
