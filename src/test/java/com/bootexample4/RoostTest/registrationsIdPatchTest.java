...
public class registrationsIdPatchTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/registrations_idPatchTest.csv");
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.body("{\n"+
					...
					"  \"revoked\": \"" + (testData.get("revoked") != null ? testData.get("revoked") : "") + "\",\n" +
					"  \"suspendedUntil\": \"" + (testData.get("suspendedUntil") != null ? testData.get("suspendedUntil") : "") + "\",\n" +
					"  \"endDate\": \"" + (testData.get("endDate") != null ? testData.get("endDate") : "") + "\n" +
 				"}")
