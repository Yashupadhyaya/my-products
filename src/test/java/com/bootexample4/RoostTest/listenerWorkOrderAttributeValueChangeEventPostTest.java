...
Test generated for /listener/workOrderAttributeValueChangeEvent_post for http method type POST in rest-assured framework

RoostTestHash=e993406981
...
public class listenerWorkOrderAttributeValueChangeEventPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/listener_workOrderAttributeValueChangeEventPostTest.csv", envVarsList);
    }

  
    @Test  
    public void listenerWorkOrderAttributeValueChangeEventPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
                ...
                .when()
                .post("/listener/workOrderAttributeValueChangeEvent")  
                .then() 
                .extract().response(); 
              JsonPath response;
              String contentType = responseObj.getContentType();

              System.out.printf("Test Case %d: listenerWorkOrderAttributeValueChangeEventPost_Test \n", testNumber++);
              System.out.println("Request: POST /listener/workOrderAttributeValueChangeEvent");
