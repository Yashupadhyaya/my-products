...
// Test generated for /order-report/orders/{id}/sub-orders/{subOrderId}/stages_get for http method type GET in rest-assured framework


// RoostTestHash=b986848f11
...
public class stagesGetTest {
  
    @Test  
    public void stages_get_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "stagesGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
                ...
                .when()
                .get("/order-report/orders/{id}/sub-orders/{subOrderId}/stages")  
                .then() 
                .extract().response();    
