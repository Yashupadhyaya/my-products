...
Test generated for /files/{file_id}/content_get for http method type GET in rest-assured framework

RoostTestHash=52854fbf84
...
public class contentGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/contentGetTest.csv");
    }

  
    @Test  
    public void contentGet_Test() {
        this.setUp();
