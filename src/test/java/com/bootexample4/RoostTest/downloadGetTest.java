...
// Test generated for /order-report/orders/download_get for http method type GET in rest-assured framework


// RoostTestHash=5503ceef91
...
public class downloadGetTest {
  
    @Test  
    public void download_get_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "downloadGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.pathParam("downloadId", map.get("downloadId") != null ? map.get("downloadId") : "")
                .when()
                .get("/order-report/orders/download")  
                .then() 
                .extract().response();    
