...
public class employeesIdGetTest {
    ...
    public void employeesIdGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("acacaca_BASE_URL") != null && !testData.get("acacaca_BASE_URL").isEmpty()) ? testData.get("acacaca_BASE_URL"): "https://virtserver.swaggerhub.com/061REB413/employee-service/0.1";  
