...
// Test generated for /order-report/orders/{id}_get for http method type GET in rest-assured framework


// RoostTestHash=462334c7e8
...
public class orders_idGetTest {
  
    @Test  
    public void orders_id_get_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "orders_idGetTest.csv"))) {  
