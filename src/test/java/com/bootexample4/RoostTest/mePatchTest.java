...
public class mePatchTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/mePatchTest.csv");
    }
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.body("{\n"+
					...
					"  \"image\": \"" + (testData.get("image") != null ? testData.get("image") : "") + "\",\n" +
					"  \"settings\": \"" + (testData.get("settings") != null ? testData.get("settings") : "") + "\n" +
 				"}")
