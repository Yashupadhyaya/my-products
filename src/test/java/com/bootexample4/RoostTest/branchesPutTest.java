...
public class branchesPutTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/branchesPutTest.csv");
    }
    ...
    public void branchesPut_Test() {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = https://virtserver.swaggerhub.com/credentialregister/wallet/1.0.0;  
				...
				.body("{\n"+
					"  \"cocNumber\": \"" + (testData.get("cocNumber") != null ? testData.get("cocNumber") : "") + "\",\n" +
					"  \"cocBranchNumber\": \"" + (testData.get("cocBranchNumber") != null ? testData.get("cocBranchNumber") : "") + "\",\n" +
					"  \"city\": \"" + (testData.get("city") != null ? testData.get("city") : "") + "\",\n" +
					"  \"tradeName\": \"" + (testData.get("tradeName") != null ? testData.get("tradeName") : "") + "\",\n" +
