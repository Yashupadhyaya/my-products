...
Test generated for /threads/{thread_id}/runs/{run_id}_get for http method type GET in rest-assured framework

RoostTestHash=235ada95d7
...
public class runsRunIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/bootexample4/RoostTest/runs_run_idGetTest.csv");
    }

  
    @Test  
    public void runsRunIdGet_Test() {
        this.setUp();
