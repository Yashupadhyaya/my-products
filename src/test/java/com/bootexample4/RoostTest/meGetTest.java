...
public class meGetTest {
  ...
  public void me_get_Test() {
    ...
    try (BufferedReader reader = new BufferedReader(
        new FileReader("src/test/java/com/bootexample4/RoostTest/meGetTest.csv"))) {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        if (response.statusCode() == 200) {
          ...
          if (response.jsonPath().get("image") != null) {
            // MatcherAssert.assertThat(response.jsonPath().getString("image"),
            // matchesPattern("^\w+:(\/?\/?)[^\s]+$"));
          ...
          if (response.jsonPath().get("email") != null) {
            // MatcherAssert.assertThat(response.jsonPath().getString("email"),
